...
{SYS_ "COPY-STREAM","si_copy_stream",1},
...
{EXT_ "RUN-PROGRAM","si_run_program",-3},
{EXT_ "TERMINATE-PROCESS","si_terminate_process",-2},
{SYS_ "WAIT-FOR-ALL-PROCESSES","si_wait_for_all_processes",-1},
...
{EXT_ "SYSTEM","ECL_NAME(si_system)",1},
...
{SYS_ "TRAP-FPE","si_trap_fpe",2},

{EXT_ "*ACTION-ON-UNDEFINED-VARIABLE*",NULL,-1},

{SYS_ "SET-BUFFERING-MODE","si_set_buffering_mode",2},
{KEY_ "NONE",NULL,-1},
...
/* #ifdef ECL_RELATIVE_PACKAGE_NAMES */
{SYS_ "*RELATIVE-PACKAGE-NAMES*",NULL,-1},
{KEY_ "RELATIVE-PACKAGE-NAMES",NULL,-1},
{SYS_ "FIND-RELATIVE-PACKAGE",IF_RELPACK("si_find_relative_package"),-1},
{SYS_ "PACKAGE-PARENT",NULL,-1},
{SYS_ "PACKAGE-CHILDREN",NULL,-1},
...
{EXT_ "MAKE-ENCODING","si_make_encoding",1},
...
{EXT_ "EXTERNAL-PROCESS-WAIT","si_external_process_wait",-2},
...
{SYS_ "SERIALIZE","si_serialize",1},
{SYS_ "DESERIALIZE","si_deserialize",1},
